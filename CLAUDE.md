...
| **R2** | Fusion topology retest under ranking (multihot held constant) | next. Levers implicated by R1: fusion (FiLM/gating/gene-reduce) + ranking loss (R-LOSS). |
| **R1-revisit** | Re-run chemistry arms under the R2+R-LOSS winner | deferred. Finalizes the encoder once arch+loss improve. |
