...
| T1 | Representation winner | T1-A complete (T1-DEC-001); multihot promoted by tiebreakers (inter-arm `no_winner` on multi_org_balanced; H-ENC-01 not adequately stress-tested by this protocol — see §12 T1-A.2 follow-up) |
